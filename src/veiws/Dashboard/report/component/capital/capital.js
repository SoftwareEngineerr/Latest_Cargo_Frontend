...
const Capital = () => {
    ...
    // Initialize with empty array if capital is null/undefined
    // First ensure capital is an array
        ...
        <div>
            ...
            <Grid container>
                ...
                {/* <Slider
                            ...
                            valueLabelDisplay="on" // Show label
                            valueLabelFormat={getLabel} // Convert value to label
                            step={1}
                            marks={marks}
                            min={1}
                            max={2}
                ...
                <Grid container>
                <Grid item lg={12}>
                     <h3 style={{ textAlign: 'center' }}>د پیسو داخلول: پدې معنی چې تاسو سوداګرۍ ته پیسې اضافه کوئ</h3>
                </Grid>
                <Grid item lg={12}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item lg={3}>
                            <Button fullWidth onClick={addCapital} variant="contained" color="primary">سرمایه اضافه</Button>
                        </Grid>
                    </Grid>
                </Grid>
            </Grid>
