...
function ReturnDetailsTable(props) {
...
const dtTo   = formatAfghanDate(props.dateTo); 
    ...
    const customerOrders = props.customerOrders
            .filter((order , index)=> order.status == "RETURN" || order.status == "return")
    ...
    if (order.status == "RETURN" || order.status == "return") {
...
h1 {
  text-align: center;
  color: ${props.color ? props.color : '#ffa800'};
  margin: 5px;
}
...
th {
  background-color: ${props.color ? props.color : '#ffa800'};
  color: white;
  padding: 5px;
  text-align: left;
}
...
.summary {
  margin-top: 30px;
  padding: 20px;
  border-top: 2px solid ${props.color ? props.color : '#ffa800'};
}
                                        ...
                                        <table>
                                            ...
                                            <tbody> 
                                                <tr>
                                                        ...
                                                        <td colspan='6'>${customerOrders.reduce((sum, order) => sum + (order.total_fees || 0) + (order.shirkat_charges || 0), 0).toLocaleString()} </td> 
                                                    </tr>
                                            </tbody>
                                        </table>
                            ...
                            `);
                                        ...
                                        sx={{
                                            backgroundColor: props.color ? props.color :  '#ffa800',
                        ...
                        <TableContainer component={Paper} variant="outlined">
                            <Table>
                                <TableHead sx={{ backgroundColor: props.color ? props.color :  '#ffa800', color:'white', textAlign:'center' }}>
                                    <TableRow>
                                    ...
                                    .map((order, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell sx={{ fontWeight: 'medium' }}>
                                                {/* {index + 1} ,  */}
                                                {/* {order.payment_date} */}
                                                {formatAfghanDate(order.date_time)}
                                            </TableCell>
                                            <TableCell sx={{ fontWeight: 'medium' }}>
                                                {index + 1}  
                                                {/* {order.srn} */}
...
// const ReturnDetailsTable = (props) => {
