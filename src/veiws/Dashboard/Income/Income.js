                    ...
                    <Grid container>
                        <Grid item lg={6} xs={12} xl={6} mt={1}>
                            <Box className='students'>
                                ...
                                <h1 className='activestd'> Total Operating Branches</h1>
                        ...
                        <Grid item lg={6} xs={12} xl={6} mt={1}>
                            <Box className='students teacher'>
                                ...
                                <h1 className='number'>1562</h1>
                                <h1 className='activestd'>New Orders</h1>
                        ...
                        <Grid item lg={6} xs={12} xl={6} mt={1}>
                            <Box className='students defaulters'>
                                ...
                                <h1 className='number'>2521</h1>
                                <h1 className='activestd'> Delivered </h1>
                        ...
                        <Grid item lg={6} xs={12} xl={6} mt={1}>
                            <Box className='students teacher removedDefaulters'>
                                ...
                                <h1 className='number'>230</h1>
                                <h1 className='activestd'> Pending... </h1>
